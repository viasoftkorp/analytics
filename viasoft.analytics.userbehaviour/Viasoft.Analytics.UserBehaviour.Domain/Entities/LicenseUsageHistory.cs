...
namespace Viasoft.Analytics.UserBehaviour.Domain.Entities
{
    ...
    public class LicenseUsageHistory : Entity
    {
        ...
        public TimeSpan AccessDuration(IDateTimeProvider dateTimeProvider)
        {
            if (EndTime.HasValue)
            {
                return EndTime.Value - StartTime;
            }
            return dateTimeProvider.UtcNow() - StartTime;
        }
        
        public int AccessDurationInMinutes(IDateTimeProvider dateTimeProvider) => (int)AccessDuration(dateTimeProvider).TotalMinutes;
    }
}